  ...
  return (
    <>
      <motion.aside
        ...
        className="fixed lg:relative z-50 h-screen w-[280px] lg:w-64 bg-white border-r border-[var(--color-border)] overflow-hidden shadow-2xl lg:shadow-lg"
      >
